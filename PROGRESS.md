...
### ⏭️ 바로 다음 할 일: 남은 2종을 3권으로 재생성 (중등 기본·중등 필수 완료)
...
예상: 중등 고난도 299p(고르기 1장 18/40유닛) / 뜯어먹는 417p(60/60 — 원래 다 1장이라
분권만 바뀜). 중등 고난도는 동의어 비중이
...
| 능률VOCA 중등 고난도 | ✅ 완료 | **신규 임포트**. 1200단어/40DAY → 4권(132~136p), 분리 유지, 페이지번호 O |
